...
Class constructor($port : Integer; $huggingfaces : cs:C1710.event.huggingfaces; $options : Object; $formula : 4D:C1709.Function; $event : cs:C1710.event.event)
	...
	While (This:C1470.huggingfaces.huggingfaces.length#0)
		...
		Case of 
			: (OB Instance of:C1731($huggingface.folder; 4D:C1709.Folder)) || (OB Instance of:C1731($huggingface.folder; 4D:C1709.File))
				Case of 
				...
				If ($request.response.status=Null:C1517)
					...
					Case of 
						: ($huggingface.domain="image")
							This:C1470.options.image_generation_model:=$huggingface.folder
						: ($huggingface.domain="diffusion")
							This:C1470.options.diffusion_model:=$huggingface.folder
						: (["vae"; "clip_l"; "t5xxl"; "llm"]).includes($huggingface.domain)
							This:C1470.options[$huggingface.domain]:=$huggingface.folder
					End case 
